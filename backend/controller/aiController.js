...
Output Format:
Return ONLY a valid JS0N array with no additional text, markdown, or formatting. Each object must have exactly two keys: "title" and "description".
...
"description": "A comprehensive overview introducing the main concepts. Sets the foundation for understanding the subject matter."
  ...
  {
"title": "Chapter 2: Cafe Principles",
...
const generateChapterContent = async (req, res) => {
 ...
 const prompt = `You are an expert writer specializinga sístyle) content. Write a complete chapter for a book with the following specifications:

Chapter Title: "${chapterTitle}"
${chapterDescription ? `Chapter Description:${chapterDescription}`: ''}
Writing Style: ${style}
Target Length: Comprehensive and detailed (ain for 1500-2500 words)
...
4. Ensure the content flows logically fros introduction to conclusion
