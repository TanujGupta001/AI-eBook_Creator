        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
          <div className="text-center mb-20 space-y-4">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-5xl font-bold text-gray-900 tracking-tight">
              ...
              <span className="block mt-2 bg-gradient-to-r from-violet-600 to-purple-600 bg-clip-text text-transparent">Create Your Ebook</span>
            </h2>
                  ...
                  <div className="relative space-y-4">
                    ...
                    <div className="pt-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <span className="text-violet-600 text-sm font-medium inline-flex items-center">
                        Learn more
                        <svg
                          className="w-4 h-4 ml-1 group-hover:translate-x-1 transform-transform "
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
