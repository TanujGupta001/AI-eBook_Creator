        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {TESTIMONIALS.map((testimonials, index) => (
              ...
              >
                {/* Quote Icon */}
                <div className="absolute -top-4 -right-4 w-12 h-12 bg-gradient-to-br from-violet-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-lg shadow-violet-500/30 rotate-6 group-hover:rotate-12 transition-transform duration-300">
                  <Quote className="w6 h-6 text-white" />
                </div>
                ...
                <div className="flex items-center space-x-1 mb-6">
                  {[...Array(testimonials.rating)].map((_, i) => (
                    <Star
                      key={i}
                      className="w-5 h- text-violet-500 fill-violet-500"
                    />
                  ))}
                </div>
                {/*Quotes*/}
          ...
          {/* Bottom Stats */}
          <div className="mt-28 grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-4xl mx-auto">
