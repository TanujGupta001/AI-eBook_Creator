...
const BookCard = ({ book, onDelete }) => {
  ...
  return (
    ...
    >
      ...
      {/* Bottom accent bar */}
      <div className="h-0.75 bg-linear-to-r from-orange-500 via-amber-500 to-rose-500 opacity-0 absolute bottom-0 left-0 right-0 transition-opacity duration-300 group-hover:opacity-100 group-focus-within:opacity-100" />
    </li>
  );
};
